// ==UserScript==
// @name Kick - NipahClient
// @namespace Violentmonkey Scripts
// @match https://kick.com/*
// @require https://code.jquery.com/jquery-3.7.1.min.js
// @require https://cdn.jsdelivr.net/npm/fuse.js@7.0.0
// @resource KICK_CSS http://localhost:3000/dist/kick.css
// @version 1.0
// @author Xzensi
// @description Improved Kick chat client.
// @grant unsafeWindow
...
(() => {
  ...
  var EmoteMenuButton = class extends AbstractComponent {
    ...
    render() {
      const basePath = "http://localhost:3000/dist/logos";
      this.$element = $(`
  ...
  var KickUserInterface = class extends AbstractUserInterface {
    ...
    loadInterface() {
      ...
      const emoteMenuButton = new EmoteMenuButton({ eventBus }).init();
  ...
  var NipahClient = class {
    ...
    async initialize() {
      ...
      if (window2.app_name === "Kick") {
        this.PLATFORM = PLATFORM_ENUM.KICK;
      ...
      let userInterface;
      if (this.PLATFORM === PLATFORM_ENUM.KICK) {
        userInterface = new KickUserInterface({ eventBus, settingsManager, emotesManager });
      } else {
        return error2("Platform has no user interface imlemented..", this.PLATFORM);
      }
    ...
    loadStyles() {
      return new Promise((resolve, reject) => {
        ...
        if (this.ENV === "development") {
          GM_xmlhttpRequest({
            method: "GET",
            url: "http://localhost:3000/dist/kick.css",
            onerror: reject,
...
// @namespace https://github.com/Xzensi/nipah-client
// @match https://kick.com/*
// @require https://code.jquery.com/jquery-3.7.1.min.js
// @require https://cdn.jsdelivr.net/npm/fuse.js@7.0.0
// @resource KICK_CSS https://github.com/Xzensi/nipah-client/dist/kick.css
// @version 1.0
// @author Xzensi
// @description Better Kick and 7TV emote integration for Kick chat.
// @supportURL https://github.com/Xzensi/nipah-client
// @homepageURL https://github.com/Xzensi/nipah-client
// @downloadURL https://github.com/Xzensi/nipah-client/dist/client.user.js
// @grant unsafeWindow
// @grant GM_getResourceText
// @grant GM_addStyle
// @grant GM.info
...
(() => {
  ...
  var NipahClient = class {
    ENV_VARS = {
      ...
      PLATFORM: PLATFORM_ENUM.NULL,
      // RESOURCE_ROOT: 'http://localhost:3000',
      RESOURCE_ROOT: "https://github.com/Xzensi/nipah-chat",
      DEBUG: true
    };
    async initialize() {
      info(`Initializing Nipah client ${this.VERSION}..`);
